            ...
            <div class="p-6">
                ...
                <div class="border-t pt-6">
                    <a href="{{ route('donations.show', $donation->id) }}"
                        class="block w-full text-center bg-gray-800 hover:bg-black text-white font-bold py-3 rounded-lg transition duration-300">
                        <i class="fas fa-hand-holding-usd mr-2"></i> View Donation Details
                    </a>
                </div>
            </div>
        </div>
