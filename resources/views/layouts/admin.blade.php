    ...
    <div class="flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 lg:translate-x-0 lg:static lg:inset-0"
            ...
            <nav class="mt-8 px-4 space-y-2">
                ...
                <a href="{{ route('admin.alumni.index') }}" class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 {{ request()->routeIs('admin.alumni.*') ? 'bg-blue-50 text-blue-600' : '' }}">
                    <i class="fas fa-users mr-3 w-5 text-center"></i>
                    <span>Alumni</span>
                </a>

                <a href="{{ route('admin.news.index') }}" class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 {{ request()->routeIs('admin.news.*') ? 'bg-blue-50 text-blue-600' : '' }}">
